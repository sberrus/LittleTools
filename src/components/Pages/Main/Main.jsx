...
import BlockImage from "../../media/img/block.jpg";
                    ...
                    <div className="col-12 col-md-6 col-sm-4 card-container mb-2">
                        <div className="card h-100">
                            ...
                            <div className="card-body bg-dark d-flex flex-column p-2 pt-5">
                                ...
                                <Link to="/" className="btn btn-outline-light disabled">
                    ...
                    <div className="col-12 col-md-6 col-sm-4 card-container mb-2">
                        <div className="card h-100">
                            ...
                            <div className="card-body bg-dark d-flex flex-column p-2  pt-5">
                                ...
                                <Link to="/quick-projects" className="btn btn-outline-light">
